...
#'
#' @details
#' - `chi_print` visualizza una tabella di contingenza arricchita con i totali per righe e colonne.
#' - `chi_print_conf` visualizza una tabella di confronto tra frequenze osservate e attese.
#' - `chi_test` esegue il test del chi quadrato per indipendenza su una tabella di contingenza.
#' - `chi_conf` esegue il test del chi quadrato per conformità, confrontando le frequenze osservate con quelle attese.
#'
#' @examples
#' # Creazione di una tabella di contingenza
#' dati <- matrix(c(10, 20, 20, 40), nrow = 2)
#' chi_print(dati, c("Maschio", "Femmina"), c("Fumatore", "Non Fumatore"))
#'
#' # Eseguire un test del chi quadrato per indipendenza
#' chi_test(dati, alpha = 0.05)
#'
#' # Visualizzare confronto frequenze osservate e attese
#' chi_print_conf(c(30, 70), c(50, 50), c("Sì", "No"), c("Fumatore", "Non Fumatore"))
#'
#' # Eseguire un test del chi quadrato per conformità
#' chi_conf(c(30, 70), c(50, 50), c("Sì", "No"), c("Fumatore", "Non Fumatore"))
#'
#' @rdname chi-quadrato
